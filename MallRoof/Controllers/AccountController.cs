...
namespace MallRoof.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Подтвердите вашу регистрацию", "Пожалуйста, подтердите вашу регистрацию, нажмите на ссылку <a href=\"" + callbackUrl + "\">здесь</a>");
                    
                    ViewBag.Message = "Проверьте вашу почту и подтвердите регистрацию. Только после этого вы сможете залогиниться";
        ...
        public async Task<ActionResult> ResendEmail(string email)
        {
            ...
            @ViewBag.Message = "Вы не проходили регистрацию";
            // If we got this far, something failed, redisplay form
